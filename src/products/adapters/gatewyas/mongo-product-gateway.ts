import { ProductModel } from '@/products/infrastructure/database/mongodb/schemas/product-schema';
import { ProductEntity } from '@/products/domain/entities/product.entity';
import { dbConnect } from '@/products/infrastructure/database/mongodb/client';
